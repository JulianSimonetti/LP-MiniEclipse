...
/**
 * Controleur de la fenêtre de déplacement de fichier quelqconque
 *
 */
public class DeplacerFichierController {
	...
	/**
	 * Set la valeur textuel du nom du fichier sur la fenêtre
	 */
	public void setProjectName() {
		projectName.setText(String.join("", "\'",noeud.getNom(),"\'") );
		projectName2.setText(String.join("", "\'",noeud.getNom(),"\'") );
	}
	/**
