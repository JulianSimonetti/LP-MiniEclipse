...
/**
 * Controleur de la vue permettant la création d'une Enumeration
 *
 */
public class CreationEnumController {
	@FXML
	...
	/**
	 * methode de creation d'enumeration
	 */
	public void creerEnum() {
